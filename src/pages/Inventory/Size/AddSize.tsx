...
const AddSize = () => {
  ...
  function onSubmit(data: Size, event: any) {
    setIsLoading(true);
    createSize(data.name)
      .then(() => {
        setIsLoading(false);
    ...
    >
      <Box sx={{ flexGrow: 1 }}>
        ...
        >
          ...
          >
            <Typography variant="subtitle1" sx={{ width: "30%" }}></Typography>
            <Alert severity="info">
              You can enter multiple sizes separated by commas (e.g., S, M, L).
            </Alert>
          </Box>
        </Box>
      </Box>
