...
import { addItem, addItemGroup as addItemGroupAPI } from "../../../api/services/inventory";
...
const AddItem = () => {
  ...
  function onSubmit(item: Item) { 
    ...
    const itemData: ItemDataInterface = {
      name: item.name,
      item_group_id: itemGroup?.groupId,
      description: item.description,
      unit_of_measure: item.unitOfMeasure,
      unit_of_bill: item.unitOfBill,
    ...
    if(varialbeRows.length > 0) {
      const variableRates = varialbeRows.flatMap((row) =>
        row.sizes.map((size) => ({
      ...
      itemData.rates.push(...variableRates);
    } else {
      itemData.rates.push({
                ...
                <CustomTooltip
                  content={
                    <span>
                      ...
                      <br />
                      If you don’t provide a SKU (Stock Keeping Unit), the
                      system will automatically generate a unique one for this
                      item.
                    </span>
                  }
                />
                    ...
                    <CustomTooltip
                      content={
                        <span>
                          ...
                          <br />
                          This unit will be used to calculate billing based on
                          the base unit multiplied by the quantity (e.g., 1 box
                          = 12 pieces).
                        </span>
                      }
                    />
                  ...
                  <CustomTooltip
                    content={
                      <>
                        ...
                        <br />
                        <br />
                        When stock drops below this value, it signals the need
                        to reorder.
                      </>
                    }
                  />
